...
export function Compliance() {
  return (
    <section id="salud" className="px-4 py-6 sm:px-6">
      <Reveal className="mx-auto max-w-[1280px] rounded-[28px] bg-sage px-6 py-16 text-center sm:px-12 lg:py-24">
        <span className="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-brand/12 text-brand-strong">
          <ShieldCheck size={28} weight="duotone" />
        </span>
        <h2 className="display mx-auto mt-7 max-w-[18ch] text-[clamp(2rem,5vw,3.75rem)] text-ink">
          En salud no basta con automatizar
        </h2>
        <p className="mx-auto mt-6 max-w-[64ch] text-lg leading-relaxed text-ink-soft">
        ...
        <p className="mx-auto mt-10 max-w-[60ch] text-base leading-relaxed text-ink-soft">
